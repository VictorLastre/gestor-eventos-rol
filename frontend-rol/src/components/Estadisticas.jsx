...
    const fetchEventos = fetchProtegido('https://hotpink-butterfly-694113.hostingersite.com/api/usuarios/estadisticas')
      .then(res => res.json());

    // ✨ RUTA TELEPÁTICA ACTUALIZADA AL NUEVO SERVIDOR DE HOSTINGER
    const fetchSistemas = fetchProtegido('https://hotpink-butterfly-694113.hostingersite.com/api/partidas/estadisticas/sistemas')
      .then(res => res.json());
