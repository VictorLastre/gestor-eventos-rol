...
    fetchProtegido('https://hotpink-butterfly-694113.hostingersite.com/api/usuarios/solicitudes-dm')
      .then(res => res.json())
      .then(datos => setSolicitudes(Array.isArray(datos) ? datos : []))
      .catch(err => { if (err !== 'Sesión expirada') console.error(err); });

    fetchProtegido('https://hotpink-butterfly-694113.hostingersite.com/api/usuarios/votaciones/activas')
      .then(res => res.json())
      .then(datos => setVotaciones(Array.isArray(datos) ? datos : []))
      .catch(err => { if (err !== 'Sesión expirada') console.error(err); });

    fetchProtegido('https://hotpink-butterfly-694113.hostingersite.com/api/eventos')
      .then(res => res.json())
...
  const cargarOraculo = () => {
    fetchProtegido('https://hotpink-butterfly-694113.hostingersite.com/api/partidas/estadisticas/sistemas')
      .then(res => res.json())
...
  const cargarCenso = () => {
    fetchProtegido(`https://hotpink-butterfly-694113.hostingersite.com/api/usuarios?limit=1000`)
      .then(res => res.json())
      .then(data => {
...
    const socket = io('https://hotpink-butterfly-694113.hostingersite.com');
...
    if (eventoId) {
      try {
        const res = await fetchProtegido(`https://hotpink-butterfly-694113.hostingersite.com/api/partidas/reporte-logistico/${eventoId}`);
...
      try {
        await fetchProtegido(`https://hotpink-butterfly-694113.hostingersite.com/api/usuarios/${idDM}/certificado-entregado`, { 
          method: 'PUT' 
        });
        cargarCenso(); 
      } catch (e) {
...
      const res = await fetchProtegido(`https://hotpink-butterfly-694113.hostingersite.com/api/usuarios/${id}/promover`, { method: 'PUT' });
      if (res.ok) { 
        cargarDatosPrincipales(); 
        cargarCenso(); 
        Swal.fire({ 
...
    if (result.isConfirmed) {
      try {
        const res = await fetchProtegido(`https://hotpink-butterfly-694113.hostingersite.com/api/usuarios/${id}/rechazar-dm`, { method: 'PUT' });
...
    if (result.isConfirmed) {
      try {
        const res = await fetchProtegido(`https://hotpink-butterfly-694113.hostingersite.com/api/usuarios/${id}/rol`, { method: 'PUT', body: JSON.stringify({ rol: nuevoRol }) });
...
    if (result.isConfirmed) {
      try {
        const res = await fetchProtegido(`https://hotpink-butterfly-694113.hostingersite.com/api/usuarios/${id}/proponer-admin`, { method: 'POST' });
...
    const res = await fetchProtegido(`https://hotpink-butterfly-694113.hostingersite.com/api/usuarios/votaciones/${votacionId}/votar`, {
      method: 'POST',
