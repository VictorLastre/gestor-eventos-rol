...
        // ✨ RUTA TELEPÁTICA ACTUALIZADA AL NUEVO SERVIDOR
        fetch('https://hotpink-butterfly-694113.hostingersite.com/api/sistemas')
          .then(res => res.json())
          .then(data => {
...
    
    // ✨ CONEXIÓN DE WEBSOCKETS ACTUALIZADA AL NUEVO SERVIDOR
...
    // ✨ RUTA TELEPÁTICA ACTUALIZADA AL NUEVO SERVIDOR
    fetchProtegido(`https://hotpink-butterfly-694113.hostingersite.com/api/partidas/${props.id}/jugadores`)
      .then(res => res.json())
...
    try {
      // ✨ RUTA TELEPÁTICA ACTUALIZADA AL NUEVO SERVIDOR
      const res = await fetchProtegido(`https://hotpink-butterfly-694113.hostingersite.com/api/partidas/${props.id}/inscripciones`, { method: metodo });
      if (res.ok) {
        setAnotado(!anotado);
...
      try {
        // ✨ RUTA TELEPÁTICA ACTUALIZADA AL NUEVO SERVIDOR
        const res = await fetchProtegido(`https://hotpink-butterfly-694113.hostingersite.com/api/partidas/${props.id}`, { method: 'DELETE' });
        if (res.ok) {
...
    try {
      // ✨ RUTA TELEPÁTICA ACTUALIZADA AL NUEVO SERVIDOR
      const res = await fetchProtegido(`https://hotpink-butterfly-694113.hostingersite.com/api/partidas/${props.id}`, {
        method: 'PUT',
