...
function Landing({ irALogin }) {
  ...
  const fundadores = [
    {
      ...
      icono: "🧙‍♂️",
      descripcion: "Aquí irá la historia de sus primeras campañas, los sistemas que domina y su visión para unir a los jugadores de La Pampa..."
    },
    {
      id: 2,
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-zinc-300 font-sans selection:bg-emerald-500/30 overflow-x-hidden relative">
      ...
      <nav className="fixed top-0 w-full bg-zinc-950/90 backdrop-blur-md border-b border-zinc-800 z-50">
        <div className="max-w-6xl mx-auto px-6 h-20 flex items-center justify-between">
          ...
          <div className="flex items-center gap-6">
            <a href="#nosotros" className="text-xs font-bold uppercase tracking-widest hover:text-emerald-400 transition-colors hidden md:block">
              El Gremio
            </a>
            <a href="#fundadores" className="text-xs font-bold uppercase tracking-widest hover:text-emerald-400 transition-colors hidden md:block flex items-center gap-2">
      ...
      {/* 🏰 PORTADA ÉPICA (HERO) */}
      <header className="relative pt-40 pb-32 px-6 flex flex-col items-center justify-center text-center overflow-hidden min-h-[80vh]">
        ...
        <div className="relative z-10 max-w-4xl animate-in fade-in slide-in-from-bottom-8 duration-1000">
          <h1 className="text-5xl md:text-7xl font-black text-white uppercase italic tracking-tighter mb-6 drop-shadow-2xl">
            ...
            <span className="text-emerald-500 not-italic">Nuestra Tierra</span>
          </h1>
          ...
          <button 
            onClick={irALogin}
            className="bg-zinc-100 text-zinc-950 hover:bg-white px-10 py-5 rounded-2xl font-black uppercase tracking-[0.2em] text-sm transition-all shadow-xl hover:scale-105 flex items-center justify-center mx-auto gap-3"
          >
      ...
      <section id="nosotros" className="py-24 px-6 bg-zinc-900/30 border-y border-zinc-800/50 relative">
        <div className="max-w-4xl mx-auto text-center relative z-10">
          <h2 className="text-3xl md:text-4xl font-black text-white uppercase tracking-tighter mb-8 flex items-center justify-center gap-4">
            <span className="text-amber-500">📜</span> Sobre el Gremio
          </h2>
          <div className="space-y-6 text-lg text-zinc-400 leading-relaxed text-justify md:text-center">
            <p>
      ...
      {/* 👑 SECCIÓN FUNDADORES */}
      <section id="fundadores" className="py-32 px-6 max-w-6xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-black text-white uppercase tracking-tighter mb-4 flex items-center justify-center gap-4">
      ...
      {/* PIE DE PÁGINA */}
      <footer className="py-10 text-center border-t border-zinc-900 text-zinc-600 text-xs font-bold uppercase tracking-widest">
