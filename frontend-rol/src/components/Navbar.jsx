...
      fetchProtegido('https://hotpink-butterfly-694113.hostingersite.com/api/usuarios/notificaciones')
        .then(res => res.json())
        .then(data => {
...
    // ✨ ACTUALIZADO AL NUEVO SERVIDOR DE HOSTINGER
...
    try {
      // ✨ RUTA TELEPÁTICA ACTUALIZADA AL NUEVO SERVIDOR DE HOSTINGER
      const res = await fetchProtegido(`https://hotpink-butterfly-694113.hostingersite.com/api/usuarios/notificaciones/${id}/leida`, {
        method: 'PUT'
      });
      if (res.ok) {
