...
      const res = await fetchProtegido(`https://hotpink-butterfly-694113.hostingersite.com/api/escapes/turnos/${turnoId}/inscripciones`, { method: 'POST' });
      if (res.ok) {
        Swal.fire({
          title: '¡Estás dentro!',
...
      try {
        // ✨ RUTA TELEPÁTICA ACTUALIZADA AL NUEVO SERVIDOR DE HOSTINGER
        const res = await fetchProtegido(`https://hotpink-butterfly-694113.hostingersite.com/api/escapes/turnos/${turnoId}/inscripciones`, { method: 'DELETE' });
...
      try {
        // ✨ RUTA TELEPÁTICA ACTUALIZADA AL NUEVO SERVIDOR DE HOSTINGER
        await fetchProtegido(`https://hotpink-butterfly-694113.hostingersite.com/api/escapes/${sala.id}`, { method: 'DELETE' });
      } catch (error) {
        console.error(error);
      }
    }
