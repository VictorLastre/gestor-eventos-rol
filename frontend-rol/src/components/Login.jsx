...
      const respuesta = await fetch('https://hotpink-butterfly-694113.hostingersite.com/api/login', {
        method: 'POST',
        headers: {
...
        
      } else {
        // ✨ MAGIA REPARADA: Parseamos la respuesta como JSON para sacar el texto limpio
